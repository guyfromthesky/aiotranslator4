...
class CloudConfigLoader:
	def __init__(self):
		# App online config
		self.bucket_id = 'nxvnaiotranslator'
		self.db_list_uri = 'nxvnaiotranslator/cloudconfig/db_list.csv'
		self.project_bucket_id = 'nxvn-aio-translator'
